...
export class SoundKit {
  ...
  /** Скрежет тормозов на конечной. */
  brake() {
    this.noise(1.4, 0.35, 320);
    this.tone(140, 40, 1.2, 'sawtooth', 0.12);
  }
  /** Нежный поцелуй. */
  kiss() {
    this.tone(520, 700, 0.12, 'sine', 0.18);
    this.tone(780, 1040, 0.18, 'sine', 0.16, 0.1);
  }
  /** Взмах крыльев голубей. */
  wings() {
    this.noise(0.3, 0.12, 1800);
    this.noise(0.25, 0.1, 2200, 0.15);
  }
  /** Свадебная фанфара. */
  fanfare() {
    this.tone(523, 523, 0.14, 'square', 0.14);
    this.tone(659, 659, 0.14, 'square', 0.14, 0.16);
    this.tone(784, 784, 0.14, 'square', 0.14, 0.32);
